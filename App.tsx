...
import { Tool, DrawingAction, BrushSettings, Layer, Theme, AccentColor, BrushPreset, Point, GridSettings } from './types';
...
const INITIAL_PRESETS: BrushPreset[] = [
  // ANIME & MANGA
  { id: 'anime-mapping-pen', name: 'Mapping Pen', category: 'Anime', tool: 'pen', settings: { ...DEFAULT_BRUSH_SETTINGS, size: 2, hardness: 1.0, flow: 1.0, stabilization: 0.8, thicknessStart: 0.1, thicknessEnd: 0.1, fadeLengthStart: 0.2, fadeLengthEnd: 0.3, pressureSize: true } },
  { id: 'anime-g-pen-pro', name: 'G-Pen Pro', category: 'Anime', tool: 'pen', settings: { ...DEFAULT_BRUSH_SETTINGS, size: 4, hardness: 1.0, flow: 1.0, stabilization: 0.7, thicknessStart: 0.2, thicknessEnd: 0.2, fadeLengthStart: 0.15, fadeLengthEnd: 0.2, pressureSize: true } },
  ...
  { id: 'anime-soft-air', name: 'Anime Airbrush', category: 'Anime', tool: 'brush', settings: { ...DEFAULT_BRUSH_SETTINGS, size: 120, hardness: 0.1, flow: 0.15, spacing: 0.05, stabilization: 0.2, pressureOpacity: true, pressureSize: false } },
  
  // TEXTURED & NATURAL
  { id: 'charcoal-gritty', name: 'Charcoal Stick', category: 'Sumi-e', tool: 'brush', settings: { ...DEFAULT_BRUSH_SETTINGS, size: 25, hardness: 0.4, flow: 0.8, spacing: 0.08, shape: 'textured', jitter: 0.1, angleJitter: 0.5, stabilization: 0.3, pressureSize: true, pressureOpacity: true } },
  { id: 'thick-oil', name: 'Thick Oil', category: 'Thick Paint', tool: 'brush', settings: { ...DEFAULT_BRUSH_SETTINGS, size: 40, hardness: 0.9, flow: 1.0, spacing: 0.02, shape: 'chisel', rotation: 45, angleFollow: true, stabilization: 0.5, pressureSize: true } },
  ...
  { id: 'dry-brush', name: 'Dry Brush', category: 'Sumi-e', tool: 'brush', settings: { ...DEFAULT_BRUSH_SETTINGS, size: 30, hardness: 0.2, flow: 0.7, spacing: 0.1, shape: 'textured', thicknessStart: 0.5, thicknessEnd: 0.1, fadeLengthEnd: 0.5, stabilization: 0.4, pressureSize: true } },

  // PENCILS
  { id: 'hb-pencil', name: 'HB Pencil', category: 'Pencils', tool: 'brush', settings: { ...DEFAULT_BRUSH_SETTINGS, size: 4, hardness: 0.7, flow: 0.9, spacing: 0.04, jitter: 0.05, shape: 'textured', stabilization: 0.6, pressureSize: true, pressureOpacity: true } },
  { id: 'soft-2b', name: 'Soft 2B', category: 'Pencils', tool: 'brush', settings: { ...DEFAULT_BRUSH_SETTINGS, size: 8, hardness: 0.6, flow: 0.8, spacing: 0.05, jitter: 0.1, shape: 'textured', stabilization: 0.5, pressureSize: true } },
      ...
      <div className="fixed inset-0 z-[600] bg-[var(--color-bg-primary)] flex items-center justify-center font-inter p-4 md:p-6">
        <div className="bg-[var(--color-bg-secondary)] w-full max-w-[580px] max-h-[95vh] rounded-3xl border border-[var(--color-border)] shadow-[0_40px_100px_rgba(0,0,0,0.6)] flex flex-col overflow-hidden animate-in">
          <div className="p-6 md:p-8 flex flex-col items-center text-center gap-1 border-b border-[var(--color-border)] bg-[var(--color-bg-tertiary)]/30">
             ...
             <h1 className="text-xl md:text-2xl font-black uppercase tracking-[0.2em]">Studio Setup</h1>
             <p className="text-[10px] font-bold opacity-40 uppercase tracking-[0.4em] mt-1">Configure your Workspace</p>
          </div>
          ...
          <div className="p-6 border-t border-[var(--color-border)] bg-[var(--color-bg-tertiary)]/30">
            <button onClick={() => setIsSetupOpen(false)} className="w-full py-4 bg-[hsl(var(--h),var(--s),var(--l))] text-white rounded-2xl text-[12px] font-black uppercase tracking-[0.3em] shadow-xl hover:brightness-110 active:scale-[0.98] transition-all flex items-center justify-center gap-3">
               Enter Studio <Languages size={14} className="opacity-40" />
            </button>
          </div>
        </div>
      </div>
